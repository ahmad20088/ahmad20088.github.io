$(function () {
  ...
  function setup() {
    ...
    createCollectable("batarang", 500, 500);
    createCollectable("batclaw", 600, 350);
    createCollectable("smoke", 700, 200);
